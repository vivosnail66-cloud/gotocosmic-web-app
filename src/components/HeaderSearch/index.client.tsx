...
/**
 * Expandable header search. Clicking the icon reveals an inline input; pressing
 * Enter (or the submit icon) navigates to `/{locale}/search?q=<query>`.
 * Blurring or pressing Esc collapses it again.
 */
export const HeaderSearchClient: React.FC<{ locale: string }> = ({ locale }) => {
